...
echo "=== Part 1: Installing NVM and Node.js ==="

# Install nvm
echo "Installing nvm..."
curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.39.0/install.sh | bash

# Create the second part of the setup script
cat > setup-part2.sh << 'EOF'
#!/bin/bash
